...
import Link from "next/link";
import { Mail, Phone, MapPin, ArrowRight, Building2, Loader2 } from "lucide-react";
import Image from "next/image";
import { motion, Variants } from "framer-motion";
...
const offices = [
  {
    ...
    mapSrc: "https://www.google.com/maps?q=206-208%20Discovery%20Road%2C%20Dandenong%20South%20VIC%203175%2C%20Australia&z=15&output=embed2"
  }
];
...
export default function ContactPage() {
          ...
          >
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full rounded-2xl border-none bg-white px-5 py-4 shadow-sm ring-1 ring-slate-200 outline-none focus:ring-2 focus:ring-[#2F6DB3] transition-all disabled:opacity-50" 
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-600 ml-1">Email Address</label>
              ...
              <motion.button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[#F47B20] py-5 font-bold text-white shadow-lg transition-colors hover:bg-[#de6f1d] disabled:bg-slate-400 disabled:cursor-not-allowed"
              >
                {isSending ? (
  ...
  <div className="container-page">
    ...
    >
      ...
      <motion.h2 variants={fadeInUp} className="mt-4 text-4xl font-black tracking-tight text-slate-900 md:text-6xl">
        Offices & Warehouses
      </motion.h2>
    </motion.div>

    <div className="mt-20 space-y-10"> {/* කිහිපයක් තිබේ නම් පරතරය තබා ගැනීමට */}
      {offices.map((office, idx) => (
        <motion.article
          key={office.title}
          initial={{ opacity: 0, y: 40 }}
        ...
        >
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-2">
                  <div className="space-y-1 text-slate-500 font-medium">
                    <p className="flex items-center gap-2">
                      <MapPin size={14} className="text-[#F47B20]"/> {office.addressLine1}
                    </p>
                    <p className="ml-5">{office.addressLine2}</p>
                    <p className="ml-5">{office.country}</p>
                  </div>
                  <div className="space-y-2 text-sm text-slate-600">
                    ...
                    <p>
                      ...
                      <a href={`mailto:${office.email}`} className="text-[#2F6DB3] font-semibold hover:underline">
                        {office.email}
                      </a>
                    </p>
                  </div>
          ...
          {/* Map Section */}
          <div className="p-4 bg-slate-50 border-t border-slate-100">
            <div className="overflow-hidden rounded-[2rem] grayscale-[0.5] hover:grayscale-0 transition-all duration-700 h-[350px]">
    <iframe 
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.067920665886!2d79.88858859999999!3d6.8824672!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25b9e3c15cba1%3A0xdbb2564793336844!2sTRANSCO%20CARGO%20PRIVATE%20LIMITED!5e0!3m2!1sen!2slk!4v1778135035060!5m2!1sen!2slk" 
  width="100%" 
  height="450" 
  style={{ border: 0 }} 
  ...
  loading="lazy" 
  referrerPolicy="no-referrer-when-downgrade"
  title="Transco Cargo Office Location"
></iframe>
            </div>
          </div>
        </motion.article>
