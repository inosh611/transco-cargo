        ...
        <div className="container-page grid gap-12 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              ...
              We respond quickly and provide clear guidance for your cargo needs.
            </p>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-semibold text-slate-900">Main Location</div>
          ...
          <div className="mt-14 grid gap-8 lg:grid-cols-2">
            {offices.map((office) => (
              ...
              >
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    <div className="rounded-2xl bg-gradient-to-br from-[#2F6DB3] to-[#F47B20] p-3 text-white shadow-lg">
                      <Building2 size={22} />
                    </div>
