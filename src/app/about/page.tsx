...
// Components (මම මේවා placeholder විදිහට තියලා තියෙන්නේ ඔයාගේ structure එකට අනුව)
import AboutMissionVisionSection from "@/components/sections/AboutMissionVisionSection";
import WorkTogether from "@/components/sections/WorkTogether";
    ...
    <main className="overflow-hidden">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden bg-slate-950">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(244,123,32,0.15),transparent_30%)]" />
        </motion.div>
        ...
        <div className="relative z-10 container-page flex h-full items-center">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="inline-flex rounded-full border border-white/15 bg-white/10 px-4 py-1.5 text-sm font-bold uppercase tracking-[0.25em] text-[#F47B20] backdrop-blur-sm"
            >
              About Us
            </motion.div>
            ...
            <motion.h1
              variants={fadeInUp}
              className="mt-6 text-4xl font-black tracking-tight text-white md:text-6xl lg:text-7xl"
            >
              Delivering Confidence <br /> Across Every Mile
            </motion.h1>
      ...
      <section className="section-space bg-white">
        <div className="container-page">
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              ...
              <div className="mt-6 space-y-5 text-lg leading-8 text-slate-600">
                <p className="text-justify">
                  Transco Cargo (Pvt) Ltd is the Sri Lankan counterpart of the
                  premier freight forwarding and turnkey logistics provider,
                  Transco Cargo Australia (Pty) Ltd, with headquarters in
                  Melbourne, Victoria.
                </p>
                <p className="text-justify">
                  With a professional network of global agents, we facilitate
                  end-to-end freight forwarding and logistics operations via
                  air, sea and road freight. Resilient to our motto,{" "}
                  <strong>“We Love to Deliver”</strong>, our experience and
                  technology make us a trustworthy partner.
                </p>
              </div>
            ...
            {/* Stats / Info Cards */}
            <motion.div variants={fadeInUp} className="relative lg:mt-0">
              <div className="rounded-2xl bg-[#2F6DB3] p-1 shadow-2xl">
                <div className="rounded-2xl bg-white p-6 md:p-10">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <motion.div
                      whileHover={{ y: -5, backgroundColor: "#255994" }}
                      className="rounded-2xl bg-[#2F6DB3] p-6 text-white transition-colors"
                    >
                    ...
                    <motion.div
                      whileHover={{ y: -5, backgroundColor: "#e06a16" }}
                      className="rounded-2xl bg-[#F47B20] p-6 text-white transition-colors"
                    >
                      <div className="text-sm opacity-80">Support</div>
                      <div className="mt-2 text-3xl font-black">24/7 Team</div>
                    </motion.div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:col-span-2">
                      ...
                      <div className="mt-3 text-lg font-semibold leading-relaxed text-slate-900">
                        Professional cargo handling, better communication, and a
                        modern logistics experience built on trust.
                      </div>
                    </div>
            ...
            {values.map((item) => {
              ...
              return (
                <motion.article
                  ...
                  variants={fadeInUp}
                  whileHover={{ y: -10 }}
                  className="group rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-xl"
                >
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#2F6DB3] text-white shadow-lg transition-transform group-hover:scale-110">
                    <Icon size={28} />
                  </div>
                  <h3 className="mt-6 text-2xl font-bold tracking-tight text-slate-900">
                    {item.title}
