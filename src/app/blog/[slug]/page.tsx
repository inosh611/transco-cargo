      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(47,109,179,0.12),_transparent_30%),linear-gradient(135deg,#f8fbff,#ffffff)]">
        <div className="container-page py-16 md:py-24">
          ...
          >
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 text-sm font-bold text-[#2F6DB3] hover:text-[#F47B20] transition-colors"
            >
              <ArrowLeft size={18} />
              Back to Blog
            </Link>
          ...
          >
            <motion.div 
              variants={fadeInUp}
              className="inline-flex rounded-full bg-[#2F6DB3]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-[#2F6DB3]"
            >
              {post.category}
            </motion.div>
            ...
            <motion.h1 
              variants={fadeInUp}
              className="mt-6 text-4xl font-black tracking-tight text-slate-900 md:text-6xl lg:text-7xl leading-[1.1]"
            >
              {post.title}
            </motion.h1>
            ...
            <motion.div 
              variants={fadeInUp}
              className="mt-8 flex flex-wrap items-center gap-6 text-sm font-medium text-slate-500"
            >
              <div className="flex items-center gap-2">
        ...
        <div className="container-page grid gap-16 lg:grid-cols-[1fr_400px]">
          ...
          <aside className="space-y-8">
              ...
              <div className="mt-8 space-y-5">
                {relatedPosts.map((item) => (
                  <Link
                    key={item.slug}
                    href={`/blog/${item.slug}`}
                    className="group block rounded-3xl border border-slate-200 bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                  >
                    <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#F47B20]">
                      {item.category}
                    </div>
                    <h3 className="mt-3 text-lg font-bold leading-snug text-slate-900 group-hover:text-[#2F6DB3] transition-colors">
                      {item.title}
                    </h3>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="sticky top-24 rounded-[2.5rem] bg-slate-900 p-8 text-white shadow-2xl overflow-hidden"
            >
              <div className="relative z-10">
                <div className="text-xs font-bold uppercase tracking-[0.25em] text-[#F47B20]">
                  Logistics Support
                </div>
                ...
                <p className="mt-4 text-slate-400 leading-relaxed">
                  Get in touch with our experts for a personalized shipping quote today.
                </p>
                
                <div className="mt-8 space-y-3">
                  <Link
                    href="/quote"
                    className="flex items-center justify-center gap-2 rounded-full bg-[#F47B20] px-6 py-4 text-sm font-bold text-white transition-transform hover:scale-105 active:scale-95"
                  >
                    Get a Quote
                    <ArrowRight size={18} />
                  </Link>
                  <Link
                    href="/contact"
                    className="flex items-center justify-center rounded-full border border-white/20 px-6 py-4 text-sm font-bold text-white transition-colors hover:bg-white/10"
                  >
                    Contact Us
                  </Link>
                </div>
              ...
              <div className="absolute -bottom-10 -right-10 h-40 w-40 rounded-full bg-[#2F6DB3]/20 blur-3xl" />
            </motion.div>
          </aside>
        </div>
      </section>
